...
class VAB(nn.Layer):
    def __init__(self, d_model, d_atten):
        ...
        initialize_weights([self.pixel_norm], 0.1)
...
class vapsr(nn.Layer):
    def __init__(self, num_in_ch, num_out_ch, scale=2, num_feat=64, num_block=23, d_atten=64, conv_groups=1):
